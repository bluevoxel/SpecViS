...
public class Step2_NewScale extends Stage {
    ...
    public Parent createContent() {
        ...
        textFieldID.setText(screenLuminanceFunctions.createScaleIndividualID(screenLuminanceFunctions.getCurrentDateYYYYmmDD(), 4));
        ...
        buttonAcceptAndSave.setOnAction(event -> {
            ...
            if (!check) {
                if (!textFieldScaleName.getText().equals("")) {
                    ...
                    screenLuminanceFunctions.saveNewScaleToFile(
                    ...
                    alert.setContentText("You can't accept & save new scale without providing its name. Name new scale " +
                            "and than try again.");
                    alert.showAndWait();
                }
            } else {
